...
type Props = { open: boolean; onClose: () => void; parcelId: string; parcelName?: string; fixedMissionId?: string; fixedDroneProfileId?: string; onAnalysisCreated: (analysis: Analysis) => void };
