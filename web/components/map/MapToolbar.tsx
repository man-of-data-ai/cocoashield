    ...
    <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 bg-white px-3 py-2.5">
      <div className="flex flex-wrap items-center gap-1.5">
        {basemaps.map(({ key, label, icon: Icon }) => (
          <button
            ...
            className={`flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-semibold transition ${basemap === key ? "bg-[#244B32] text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900"}`}
          >
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        <button
          ...
          className={`flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-semibold transition ${layers.zones ? "bg-[#244B32] text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"}`}
