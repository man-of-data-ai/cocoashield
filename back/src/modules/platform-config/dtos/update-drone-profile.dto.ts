...
export class UpdateDroneProfileDto {
  @IsOptional() @IsString() @MinLength(1) profileId?: string;
  @IsOptional() @IsString() @MinLength(1) manufacturer?: string;
  ...
  @IsOptional() @IsString() @MinLength(1) metadataFormat?: string;
